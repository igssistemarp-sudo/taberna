...
import PedidosApp from "./pedidos/PedidosApp";
...
const isPedidosRoute = window.location.pathname.startsWith("/pedidos");
createRoot(document.getElementById("root")!).render(isPedidosRoute ? <PedidosApp /> : <App />);
